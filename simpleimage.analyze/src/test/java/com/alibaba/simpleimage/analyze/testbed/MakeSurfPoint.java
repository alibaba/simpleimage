 ...
 */
public class MakeSurfPoint extends Thread {

    private String[] args;
    private int      idx;

    public MakeSurfPoint(String[] args, int idx){
        this.args = args;
        this.idx = idx;
    }

    public void run() {
        makeSpFile(args[0], args[1], idx);
    }
    ...
    public static void main(String[] args) {
        ...
        args[1] = "/Users/axman/Downloads/model/rsurf/";
    ...
    private static void makeSpFile(String imgDir, String pntDir, int offset) {
